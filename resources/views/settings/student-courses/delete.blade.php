<x-layout.user content-view :$backRoute class="settings form" title="Delete Student Course">
<div class="article">
	<p>
		Are you sure you want to delete student course "<strong>{{ $course->name }}</strong>"?
	</p> 
