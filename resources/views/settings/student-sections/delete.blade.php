<x-layout.user content-view :$backRoute class="settings form" title="Delete Student Section">
<div class="article">
	<p>
		Are you sure you want to delete student section "<strong>{{ $section->section }}</strong>"?
	</p> 
