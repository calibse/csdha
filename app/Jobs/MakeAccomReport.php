...
class MakeAccomReport implements ShouldQueue, ShouldBeUnique
{
    ...
    public function __construct(public Gpoa $gpoa, public Event $event, 
        public User $user)
    {
        //
    }
    ...
    public function handle(): void
    {
        ...
        $gpoaActive = $this->gpoa?->active;
        if (!$event || !$accomReport || !$this->user || !$gpoaActive) return;
    ...
    {
        return $this->event->id . '_' . $this->user->id;
    }
}
